...
const ChoosePaymentMethodPage = () => {
  ...
  const bankMethods = methods.filter((m: any) => m.type.toLowerCase() === "bank");
  const qrMethods = methods.filter((m: any) => m.type.toLowerCase() === "qr");
          ...
          {isLoading ? (
            ...
            <div className="p-8 md:p-10 flex flex-col gap-6">
              {bankMethods.map((m: any) => (
                ...
                // style={{
                //   border: selectedMethod?._id === m._id
                //     ? "1px solid rgba(138,255,236,0.6)"
                //     : "1px solid rgba(56,71,109,0.15)",
                //   background: selectedMethod?._id === m._id
                //     ? "rgba(16,30,62,0.4)"
                //     : "transparent",
                // }}
                >
        ...
        <div className="flex items-center gap-4 mt-6">
          ...
          <Button
            ...
            onClick={() => {
              ...
              dispatch(setPaymentMethod(method._id));
